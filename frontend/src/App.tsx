...
export default function App() {
  ...
  return <div className="app-shell">
    <main className="content" inert={detailOpen} aria-hidden={detailOpen || undefined}>
      ...
      {tab === "more" && <MorePage config={config} reportError={reportError} imported={() => { void syncConfig(); }} theme={theme} onThemeChange={nextTheme => { void changeTheme(nextTheme); }} />}
    </main>
