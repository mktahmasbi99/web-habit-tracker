...
function MorePage({ config, reportError, imported }: { config: Config; reportError: (error: unknown) => void; imported: () => void }) {
  const [advancedOpen, setAdvancedOpen] = useState(false); const [legacyOpen, setLegacyOpen] = useState(false); const [uploadOpen, setUploadOpen] = useState(false); const [showSafety, setShowSafety] = useState(false);
